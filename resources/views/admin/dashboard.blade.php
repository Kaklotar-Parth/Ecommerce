            ...
            <div class="row" id="main">
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block" href="{{ url('admin/products') }}"><span
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block" href="{{ url('admin/orders') }}"><span
                                class="pull-left">View All</span><span class="pull-right"><i
                                    class="fa fa-chevron-circle-right"></i>
                            </span>
                        </a><!-- END panel-->
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block"
                            href="{{ url('admin/withdraws/pending') }}"><span class="pull-left">View All</span><span
                                class="pull-right"><i class="fa fa-chevron-circle-right"></i>
                            </span>
                        </a><!-- END panel-->
                    </div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block" href="{{ url('admin/customers') }}"><span
                                class="pull-left">View All</span><span class="pull-right"><i
                                    class="fa fa-chevron-circle-right"></i>
                            </span>
                        </a><!-- END panel-->
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block"
                            href="{{ url('admin/vendors/pending') }}"><span class="pull-left">View All</span><span
                                class="pull-right"><i class="fa fa-chevron-circle-right"></i>
                            </span>
                        </a><!-- END panel-->
                    </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block" href="{{ url('admin/vendors') }}"><span
                                class="pull-left">View All</span><span class="pull-right"><i
                                    class="fa fa-chevron-circle-right"></i>
                            </span>
                        </a><!-- END panel-->
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="panel panel-default">
                        ...
                        <a class="panel-footer detail-link clearfix btn-block"
                            href="{{ url('admin/subscribers') }}"><span class="pull-left">View All</span><span
                                class="pull-right"><i class="fa fa-chevron-circle-right"></i>
                            </span>
                        </a><!-- END panel-->
                    </div>
