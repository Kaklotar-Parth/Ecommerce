                ...
                @for ($i = 0; $i < count($sliders); $i++)
                    @if ($i == 0)
                        ...
                        <div class="item active">
                            ...
                            <!-- Slide Background -->
                            <img src="{{ url('/') }}/assets/images/sliders/{{ $sliders[$i]->image }}"
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs home-tab" role="tablist">
                            <li class="active"><a href="#home" aria-controls="home" role="tab"
                                    data-toggle="tab">Feature Products</a></li>
                            <li><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"> Latest
                                    Products</a></li>
                            <li><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Popular
                                    Products</a></li>
                            <li><a href="#virtual" aria-controls="virtual" role="tab" data-toggle="tab">Virtual
                                    Products</a></li>
                            <li><a href="#physical" aria-controls="physical" role="tab" data-toggle="tab">Physical
                                    Products</a></li>
                        </ul>
                    </div>
                    <!-- Tab panes -->
                                ...
                                @foreach ($features as $product)
                                    <div class="col-xs-6 col-sm-4 col-md-3 product">
                                        <article class="col-item">
                                            <div class="photo">
                                                @php $fileExtension = pathinfo($product->feature_image, PATHINFO_EXTENSION); @endphp
                                                @php $filePath = url('/assets/images/products/' . $product->feature_image); @endphp
                                                    ...
                                                    <div class="price-details">
                                                        ...
                                                        <div class="pull-left">
                                                            @if ($product->previous_price != '')
                                                                <span
                                                                    class="price-old">${{ $product->previous_price }}</span>
                                                            @else
                                                            @endif
                                                    ...
                                                    <form>
                                                        <p>
                                                            ...
                                                            @if ($product->stock != 0 || $product->stock === null)
                                                                <button type="button" class="button style-10 to-cart">Add
                                                                    to cart</button>
                                                            @else
                                                                <button type="button" class="button style-10 to-cart"
                                                    ...
                                                    <div class="price-details">
                                                        ...
                                                        @elseif (in_array($fileExtension, ['mp4', 'avi', 'mov', 'webm']))
                                                            ...
                                                            <iframe src="{{ $filePath }}" width="100%"
                                                                height="320px" style="border: none;"
