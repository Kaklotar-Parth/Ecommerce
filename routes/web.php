...
// Route::get('/listall', 'FrontEndController@');
...
Route::get('/checkout1', 'VirtualController@checkout1')->name('virtual.checkout1');
...
Route::post('/cashondelivery1', 'FrontEndController@cashondelivery1')->name('cash1.submit');
...
Route::resource('/admin/product', 'VirtualController');
